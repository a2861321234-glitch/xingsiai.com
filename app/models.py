...
class SiteSetting(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    hero_title = db.Column(db.String(255), default="DISCOVER INDUSTRIAL ELEGANCE")
    hero_subtitle = db.Column(
        db.Text,
        default="形思工业设计为品牌打造兼具功能与审美的工业设计作品，从灵感捕捉到量产落地，全程协同。",
    )
    hero_cta_text = db.Column(db.String(120), default="联系我们")
    hero_cta_link = db.Column(db.String(255), default="#contact")
    hero_secondary_cta_text = db.Column(db.String(120), default="浏览案例")
